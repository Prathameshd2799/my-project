...
<head>
    ...
    <title><?php echo ucwords(str_replace('_','',$page)) ?> | Kisan-Agri-Mall</title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link  <?php echo ($page == 'corder')? 'active' : '' ?>" href="./?page=corder">Orders</a>
                    </li>
                   <li class="nav-item">
                        <a class="nav-link <?php echo ($page == 'customers')? 'active' : '' ?>" aria-current="page" href="./?page=customers">Customers</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo ($page == 'users')? 'active' : '' ?>" aria-current="page" href="./?page=users">Delivery Boy</a>
                    </li>
                    <li class="nav-item">
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                    <li><a class="dropdown-item" href="./?page=stock_report">Stock Report</a></li>
                    <li><a class="dropdown-item" href="./?page=report">Sales Report</a></li>
                    <li><a class="dropdown-item" href="./?page=customer_report">Customer Report</a></li>
                    <li><a class="dropdown-item" href="./?page=product_report">Product Report</a></li>
                </ul>
            </div>
                </ul>
            </div>
