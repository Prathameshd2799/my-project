        ...
        <div class="card">
            <div class="card-body">
                ...
                <table class="table table-bordered table-hover table-stripped">
                                ...
                                <div class="w-100 d-flex">
                                    ...
                                    <div class="col-auto flex-grow-1">
                                        ...
                                        <div class="d-flex w-100">
                                            <div class="col-auto">
                                                <input type="number" value="<?php echo number_format($row['quantity'],0,'.','') ?>" class="form-control form-control-sm rounded-0 py-0 qty text-center col-1" style="width:100px" required>
                    ...
                    <center><button class="btn btn-dark btn-sm rounded-0"  style="display:none" type="button" id="checkout" name="checkout">Checkout</button></center>
                    <label for="fee_id" class="control-label"><b>Note:- Due to Payment security reason only Cash On Delivery(COD) mode is available</b></label><br>
...
<script> 
    ...
    uni_modal("Checkout","place_order.php?total="+$('[name="total"]').val(),'mid-large', function() {
        location.reload();
    });
